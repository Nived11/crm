...
import {
  ...
  ChevronDown, ChevronUp, Phone, Tag, MoreVertical, Building2
} from "lucide-react";
                      ...
                      <React.Fragment key={client.id}>
                        ...
                        >
                          ...
                          <td className="p-6">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="text-sm font-bold text-white leading-none mb-1.5">{client.company_name || 'N/A'}</p>
                                <div className="flex items-center gap-2 text-zinc-500">
                                  <Tag size={10} className="text-brand/60" />
                                  <p className="text-[10px] font-bold uppercase tracking-tight">{client.category_name || 'General'}</p>
                                </div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="p-6 text-center">
                            <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border shadow-sm ${client.status === 'Interested' ? 'bg-green-500/10 border-green-500/20 text-green-500' :
                        ...
                        {expandedRows.includes(client.id) && (
                          <tr className="bg-zinc-900/20">
                            <td colSpan={6} className="p-8 border-t border-zinc-900/50">
                  ...
                  <div key={client.id} className="p-5 active:bg-zinc-900/30 transition-all relative">
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center gap-3 flex-1" onClick={() => toggleRow(client.id)}>
                        <div className="w-11 h-11 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500"><Building2 size={20} /></div>
                        <div>
                    ...
                    <div className="flex flex-col gap-3" onClick={() => toggleRow(client.id)}>
                      ...
                      <div className="flex items-center justify-between bg-zinc-900/40 p-3 rounded-xl border border-zinc-800/50">
                        <div className="flex flex-col">
                          ...
                          <span className={`text-[10px] font-black uppercase tracking-tight ${client.status === 'Interested' ? 'text-green-500' :
